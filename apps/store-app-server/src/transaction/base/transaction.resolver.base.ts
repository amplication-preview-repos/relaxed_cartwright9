...
export class TransactionResolverBase {
  ...
  async getBox(@graphql.Parent() parent: Transaction): Promise<Box | null> {
    const result = await this.service.getBox(parent.id);
